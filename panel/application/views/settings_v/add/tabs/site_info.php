...
<div class="tab-pane fade show active" id="site-informations" role="tabpanel" aria-labelledby="site-informations-tab">
    ...
    <div class="row">
        <div class="form-group col-md-6">
            <label>Fax 1</label>
            <input class="form-control form-control-sm rounded-0" placeholder="Fax numaranız" name="fax_1">
        </div>
        <div class="form-group col-md-6">
            <label>Fax 2</label>
            <input class="form-control form-control-sm rounded-0" placeholder="Diğer fax numaranız (opsiyonel)" name="fax_2">
        </div>
    </div>
</div>