            ...
            <?php foreach ($settings as $key => $value) : ?>
                <div class="tab-pane fade <?= ($key == 0 ? 'show active' : null) ?>" id="lang-<?= $value->lang ?>" role="tabpanel" aria-labelledby="lang-<?= $value->lang ?>-tab">
                    <div class="form-group">
                        ...
                        <input class="form-control form-control-sm rounded-0" placeholder="Ad Soyad [Dil : <?=$value->lang?>]" name="full_name[<?=$value->lang?>]" required>
                    </div>
                    <div class="form-group">
                        <label>Şirket Adı</label>
                        <input class="form-control form-control-sm rounded-0" placeholder="Şirket Adı [Dil : <?=$value->lang?>]" name="company[<?=$value->lang?>]" required>
                    </div>
                    <div class="form-group">
                        <label>Başlık</label>
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control form-control-sm rounded-0 tinymce" name="content[<?=$value->lang?>]" placeholder="Bizimle ilgili mesaj... [Dil : <?=$value->lang?>]" required></textarea>
                    </div>
