            ...
            <?php foreach ($settings as $key => $value) : ?>
                ...
                <div class="tab-pane fade <?= ($key == 0 ? 'show active' : null) ?>" id="lang-<?= $lang ?>" role="tabpanel" aria-labelledby="lang-<?= $lang ?>-tab">
                    <div class="form-group">
                        ...
                        <input class="form-control form-control-sm rounded-0" placeholder="Sayfa Adı [Dil : <?= $lang ?>]" name="title[<?= $lang ?>]" value="<?= !empty($item->title->$lang) ? $item->title->$lang : null; ?>" required>
                    </div>
                    <div class="form-group">
