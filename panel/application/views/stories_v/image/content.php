...
<div class="container-fluid mt-xl-50 mt-lg-30 mt-15 bg-white p-3">
                ...
                <div class="tab-pane fade <?= ($key == 0 ? 'show active' : null) ?>" id="lang-<?= $lang ?>" role="tabpanel" aria-labelledby="lang-<?= $lang ?>-tab">
                    <div class="row">
                        <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                            <form data-table="detailTable" action="<?= base_url("stories/file_upload/$item->id/$lang"); ?>" id="dropzone<?=$lang?>" class="dropzone" data-plugin="dropzone" data-options="{ url: '<?= base_url("stories/file_upload/$item->id/$lang"); ?>'}">
    ...
    <div class="row">
        <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
            <h4 class="my-3">
                <b><?= json_encode($item->title); ?></b> kaydına ait Hikaye İçerikleri
            </h4>
            <hr>
        </div><!-- END column -->
        <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
