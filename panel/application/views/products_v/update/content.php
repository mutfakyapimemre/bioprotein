        ...
        <div class="tab-content" id="myTabContent">
            <?php foreach ($settings as $key => $value) : ?>
                ...
                <div class="tab-pane fade <?= ($key == 0 ? 'show active' : null) ?>" id="lang-<?= $lang ?>" role="tabpanel" aria-labelledby="lang-<?= $lang ?>-tab">
                    ...
                    <div class="form-group">
                        <label>Fiyat</label>
                        <input class="form-control form-control-sm rounded-0" placeholder="Başlık [Dil : <?= $lang ?>]" name="price[<?= $lang ?>]" value="<?= !empty($item->price->$lang) ? $item->price->$lang : null; ?>" required>
                    </div>
                    <div class="form-group">
