...
class Menu_model extends CI_Model
{
	...
	{
		parent::__construct();
		$this->column_order = array('rank', 'id', 'id', 'title','position','top_id','url', 'isActive','createdAt','updatedAt');
        // Set searchable column fields
        $this->column_search = array('rank', 'id', 'id', 'title','position','top_id','url', 'isActive','createdAt','updatedAt');
        // Set default order
