...
class Product_image_model extends CI_Model
{
    ...
    public function __construct()
    {
        ...
        $this->column_order = array('product_images.rank', 'product_images.id', 'product_images.id', 'product_images.url', 'product_images.url', 'product_images.lang', 'product_images.isCover', 'product_images.isActive', 'product_images.createdAt', 'product_images.updatedAt');
        // Set searchable column fields
        $this->column_search = array('product_images.rank', 'product_images.id', 'product_images.id', 'product_images.url', 'product_images.url', 'product_images.lang', 'product_images.isCover', 'product_images.isActive', 'product_images.createdAt', 'product_images.updatedAt');
        // Set default order
        $this->order = array('product_images.rank' => 'ASC');
    }
