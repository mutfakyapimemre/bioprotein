...
class File_model extends CI_Model
{
	...
	public function __construct()
	{
        ...
        $this->column_order = array('files.rank', 'files.id', 'files.id', 'files.url', 'files.url','files.lang','files.isActive', 'files.createdAt','files.updatedAt','files.sharedAt');
        // Set searchable column fields
        $this->column_search = array('files.rank', 'files.id', 'files.id', 'files.url', 'files.url','files.lang','files.isActive', 'files.createdAt','files.updatedAt','files.sharedAt');
        // Set default order
