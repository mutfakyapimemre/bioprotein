...
class Settings_model extends CI_Model
{
	...
	{
		parent::__construct();
		$this->column_order = array('rank', 'id', 'id', 'company_name','language','createdAt','updatedAt','isActive');
        // Set searchable column fields
        $this->column_search = array('rank', 'id', 'id', 'company_name','language','createdAt','updatedAt', 'isActive');
        // Set default order
