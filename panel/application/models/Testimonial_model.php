...
class Testimonial_model extends CI_Model
{
    ...
    {
        parent::__construct();
        $this->column_order = array('rank', 'id', 'id', 'title', 'content', 'full_name', 'isActive', 'createdAt', 'updatedAt', 'sharedAt');
        // Set searchable column fields
        $this->column_search = array('rank', 'id', 'id', 'title', 'content', 'full_name', 'isActive', 'createdAt', 'updatedAt', 'sharedAt');
        // Set default order
