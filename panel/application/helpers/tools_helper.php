...
//100,200
//uploads/$t->viewFolder/deneme.webp
function upload_picture($file, $uploadPath, $lang = "", $allowedTypes = "bmp|gif|jpeg|jpg|jpe|jp2|j2k|jpf|jpg2|jpx|jpm|mj2|mjp2|tiff|tif|svg|ico|png|webp")
{
    ...
    if (!$t->upload->do_upload($file, $lang)) {
