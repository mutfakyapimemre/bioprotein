        ...
        foreach ($items as $item) {
            ...
            <div class="dropdown">
                ...
                <div class="dropdown-menu rounded-0 dropdown-menu-right" aria-labelledby="dropdownMenuButton">
                    ...
                    <a class="dropdown-item remove-btn" href="javascript:void(0)" data-table="homeAdsTable" data-url="' . base_url("ads/delete/$item->id") . '"><i class="fa fa-trash mr-2"></i>Kaydı Sil</a>
                    </div>
            </div>';
