...
<div class="rs-breadcrumbs">
    <img src="<?= base_url("public/images/bg/contact-bg.webp") ?>" alt="<?= strto("lower|upper", $languageJSON["routes"]["galeriler"]); ?>">
    <div class="breadcrumbs-inner">
        <div class="container">
            <div class="row">
                <div class="col-md-12 text-center">
                    <h1 class="page-title"><?= strto("lower|upper", $languageJSON["routes"]["galeriler"]); ?></h1>
                    <ul>
                        <li>
...
<div id="rs-gallery-sction" class="rs-gallery-sction3 gallery-page pt-100 pb-100">
    <div class="container">
        <div class="row pagination-gallery">
                    ...
                    <div class="col-12 col-sm-12 col-md-6 col-lg-4 col-xl-4">
                        <div class="gallery-item popup-inner">
                            <div class="gallery-content popup-box">
                                <picture>
                                    <img src="<?= get_picture("galleries_v/{$value->gallery_type}/{$value->folder_name->$lang}", $value->img_url->$lang) ?>" data-src="<?= get_picture("galleries_v/{$value->gallery_type}/{$value->folder_name->$lang}", $value->img_url->$lang) ?>" alt="<?= $value->title->$lang ?>" class="img-fluid lazyload w-100" style="min-height: 225px;object-fit:cover">
                                </picture>
                                <div class="popup-text">
                                    <a rel="dofollow" href="<?= base_url($languageJSON["routes"]["galeriler"] . "/" . $languageJSON["routes"]["galeri"] . "/{$value->url->$lang}") ?>" title="<?= $value->title->$lang ?>"><?= $value->title->$lang ?></a>
