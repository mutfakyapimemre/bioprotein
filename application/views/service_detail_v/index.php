...
<div class="rs-breadcrumbs">
    <img src="<?= base_url("public/images/bg/contact-bg.webp") ?>" alt="<?= strto("lower|upper", $service->title->$lang) ?>">
    <div class="breadcrumbs-inner">
        <div class="container">
            <div class="row">
                <div class="col-md-12 text-center">
                    <h1 class="page-title"><?= strto("lower|upper", $service->title->$lang) ?></h1>
                    <ul>
                        ...
                        <li><a class="active" rel="dofollow" href="<?= base_url($languageJSON["routes"]["hizmetlerimiz"]); ?>" title="<?= strto("lower|upper", $languageJSON["routes"]["hizmetlerimiz"]); ?>"><?= strto("lower|upper", $languageJSON["routes"]["hizmetlerimiz"]); ?></a></li>
                        <li><?= strto("lower|upper", $service->title->$lang) ?></li>
                    </ul>
                </div>
            </div>
        </div>
...
<div class="rs-classes-details  sec-spacer">
    <div class="container">
        <div class="row">
            <div class="col-lg-8">
                <div class="detail-img">
                    <picture>
                        <img src="<?= get_picture("services_v", $service->img_url->$lang) ?>" data-src="<?= get_picture("services_v", $service->img_url->$lang) ?>" alt="<?= $service->title->$lang ?>" class="img-fluid w-100 lazyload" style="min-height:200px;object-fit:cover">
                    </picture>
                </div>
                <div class="course-content">
                    <h3 class="classes-title uppercase mb-1"><?= $service->title->$lang ?></h3>
                    <small class="date"><?= iconv("ISO-8859-9", "UTF-8", strftime("%d %B %Y, %A %X", strtotime($service->updatedAt))); ?></small>
                </div>
